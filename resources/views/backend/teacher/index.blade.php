                ...
                <div class="table-responsive" style="overflow-x: auto; max-height: 400px;">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        <form action="{{ route('teacher') }}" method="GET" class="mb-3">
                            <div class="input-group">
                                <input type="search" name="search" class="form-control" placeholder="Cari Data Guru"
                    ...
                    <table class="table table-bordered table-hover text-start">
                        ...
                        <tbody>
                            ...
                            @else
                            <tr>
                                <td colspan="9" class="text-center text-danger fw-bold">Data Guru Tidak Ditemukan</td>
                            </tr>
                            @endif
                        </tbody>
                    </table>
